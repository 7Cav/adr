...
function RRDList (listArray) {
    var {listArray} = listArray
    var array = [];
    var rrdStaffPositions = ['64','65','577','578','579','580'];
    ...
    for (var milpacIdCombat in listArray[0].combat.profiles) {
        ...
        if (rrdStaffPositions.includes(primary.positionId)) {
        ...
        for (var index in listArray[0].combat.profiles[milpacIdCombat].secondaries) {
            ...
            if (!rrdStaffPositions.includes(secondary.positionId)) {
                continue;
            }
    ...
    for (var milpacIdReserve in listArray[0].reserve.profiles) {
        ...
        if (rrdStaffPositions.includes(rPrimary.positionId)) {
        ...
        for (var rIndex in listArray[0].reserve.profiles[milpacIdReserve].secondaries) {
            ...
            if (!rrdStaffPositions.includes(rSecondary.positionId)) {
                continue;
            }
