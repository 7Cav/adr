export class AwardRegistry {
  ...
  initalizeAwards() {
      ...
      this.awards.set("Bronze Star", {awardPriority: 11, awardAttachmentType: "oakClusters", awardType: "Medal"});
      ...
      this.awards.set("Army Air Medal", {awardPriority: 15, awardAttachmentType: "ncoNums", awardType: "Medal"});
      this.awards.set("Joint Service Commendation Medal", {awardPriority: 16, awardAttachmentType: "oakClusters", awardType: "Medal"});
      this.awards.set("Army Commendation Medal", {awardPriority: 17, awardAttachmentType: "oakClusters", awardType: "Medal"});
